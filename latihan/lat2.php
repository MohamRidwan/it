...
<center><h2><b><i>Starat Masuk Ke MicoMoll</i></b></h2></center>
<form method= "POST" action="has2.php">
<div class="container">
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Setatus Vaksin</label>
    <select name="vaksin" class="form-control" Value="" required>
